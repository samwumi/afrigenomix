...
export default function AdminContentPage() {
  ...
  useEffect(() => {
    // Refresh articles when component mounts (e.g., after redirect from creating article)
    const params = new URLSearchParams(window.location.search);
    if (params.get('refresh') === 'true') {
      // Clear filters to show all articles
        ...
        <Container>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            ...
            <div className="flex gap-2 w-full md:w-auto">
              ...
              <Link href="/admin/content/new" className="flex-1 md:flex-none">
                <Button size="lg" variant="primary" className="shadow-lg hover:shadow-xl group w-full">

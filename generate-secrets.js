...
console.log('DATABASE_URL="mysql://u215495167_afrigenomix:Afrigenomix@2026@localhost:3306/u215495167_afrigenomix"');
console.log('JWT_SECRET="' + jwtSecret + '"');
console.log('NEXTAUTH_SECRET="' + nextAuthSecret + '"');
...
console.log('\n📝 Save this to /home/u215495167/public_html/afrigenomix/.env on your server\n');
